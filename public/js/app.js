...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_homepage__ = __webpack_require__(7);
console.log("ready!");
/*———————————————————————————————————*\
    $ LIBRAIRIES
\*———————————————————————————————————*/
...
var routes = new __WEBPACK_IMPORTED_MODULE_2__util_Router__["a" /* default */]({
    ...
    homepage: __WEBPACK_IMPORTED_MODULE_4__pages_homepage__["a" /* default */]
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_navbar__ = __webpack_require__(8);
/*———————————————————————————————————*\
    $ IMPORTS
\*———————————————————————————————————*/
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__components_navbar__["a" /* open */]();
    // Code perso
